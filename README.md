...
[ws_server.py](./ws_server.py)	[server](./src/sp_iotsim/server.py)
emits data packets with random timing to the backend service	that emits data packets with random timing to the backend
[ws_client.py](./ws_client.py).	[client](./src/sp_iotsim/client.py).
...
```sh
python ws_client.py	python -m sp_iotsim.client
```
